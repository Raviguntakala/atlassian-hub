...
if os.getenv(
    ...
    try:
        ...
        logging.getLogger("atlassian-hub").warning(
...
from atlassian_hub.utils.logging import setup_logging

try:
    __version__ = version("atlassian-hub")
...
@click.version_option(__version__, prog_name="atlassian-hub")
@click.command()
@click.option(
    "-v",
    "--verbose",
