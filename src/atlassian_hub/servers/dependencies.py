...
if TYPE_CHECKING:
    from atlassian_hub.confluence.config import (
        ConfluenceConfig as UserConfluenceConfigType,
    )
    from atlassian_hub.jira.config import JiraConfig as UserJiraConfigType

logger = logging.getLogger("atlassian-hub.servers.dependencies")
