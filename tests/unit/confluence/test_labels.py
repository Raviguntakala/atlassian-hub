...
from atlassian_hub.confluence.labels import LabelsMixin
from atlassian_hub.models.confluence import ConfluenceLabel
...
class TestLabelsMixin:
    ...
    def labels_mixin(self, confluence_client):
        ...
        with patch(
            "atlassian_hub.confluence.labels.ConfluenceClient.__init__"
        ) as mock_init:
