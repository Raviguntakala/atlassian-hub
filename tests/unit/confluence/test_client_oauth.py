...
class TestConfluenceClientOAuth:
    ...
    def test_init_with_oauth_config(self):
        ...
        with (
            ...
            patch(
                "atlassian_hub.confluence.client.configure_oauth_session"
    ...
    def test_from_env_with_standard_oauth(self):
        ...
        with (
            ...
            patch(
                "atlassian_hub.confluence.config.get_oauth_config_from_env",  # Patch the correct utility
    ...
    def test_from_env_with_byo_token_oauth(self):
        ...
        with (
            ...
            patch(
                "atlassian_hub.confluence.config.get_oauth_config_from_env",
