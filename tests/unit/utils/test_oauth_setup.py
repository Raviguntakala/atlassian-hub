...
from atlassian_hub.utils.oauth_setup import (
    OAuthSetupArgs,
    parse_redirect_uri,
    run_oauth_flow,
    run_oauth_setup,
...
class TestOAuthFlow:
    ...
    def reset_oauth_state(self):
        ...
        import atlassian_hub.utils.oauth_setup as oauth_module
    ...
    def test_run_oauth_flow_success_localhost(self):
        ...
        with MockOAuthServer.mock_oauth_flow() as mocks:
            with (
                patch(
                    "atlassian_hub.utils.oauth_setup.OAuthConfig"
                ) as mock_oauth_config,
                patch("atlassian_hub.utils.oauth_setup.wait_for_callback") as mock_wait,
                patch(
                    "atlassian_hub.utils.oauth_setup.start_callback_server"
    ...
    def test_run_oauth_setup_with_env_vars(self):
        ...
        with MockEnvironment.oauth_env() as env_vars:
            with (
                ...
                patch(
                    "atlassian_hub.utils.oauth_setup.run_oauth_flow", return_value=True
                ) as mock_flow,
            ):
    ...
    def test_run_oauth_setup_flow_failure(self):
        ...
        with MockEnvironment.clean_env():
            with (
                ...
                patch(
                    "atlassian_hub.utils.oauth_setup.run_oauth_flow", return_value=False
                ),
            ):
                result = run_oauth_setup()
                assert result == 1
