...
from atlassian_hub.utils.oauth import BYOAccessTokenOAuthConfig, OAuthConfig
...
class TestJiraClientOAuth:
    ...
    def test_init_with_oauth_config(self):
        ...
        with (
            ...
            patch(
                "atlassian_hub.jira.client.configure_oauth_session"
    ...
    def test_init_with_oauth_failed_session_config(self):
        ...
        with (
            ...
            patch(
                "atlassian_hub.preprocessing.jira.JiraPreprocessor"
    ...
    def test_init_with_byo_oauth_failed_session_config(self):
        ...
        # Mock dependencies with OAuth configuration failure
        with (
            patch("atlassian_hub.jira.client.Jira"),  # No need to assert mock_jira
            patch(
                "atlassian_hub.jira.client.configure_oauth_session"
            ) as mock_configure_oauth,
    ...
    def test_from_env_with_oauth(self):
        ...
        with (
            ...
            patch(
                "atlassian_hub.jira.config.get_oauth_config_from_env",
            ...
            patch("atlassian_hub.jira.client.Jira") as mock_jira,
            patch(
                "atlassian_hub.jira.client.configure_oauth_session", return_value=True
            ) as mock_configure_oauth,
            patch(
                "atlassian_hub.jira.client.configure_ssl_verification"
            ) as mock_configure_ssl,
